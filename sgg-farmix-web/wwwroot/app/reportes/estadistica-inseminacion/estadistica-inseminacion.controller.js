(function () {
    ...
    estadisticaInseminacionController.$inject = ['$location', '$scope', '$localStorage', 'estadisticaInseminacionService', 'toastr', '$sessionStorage'];

    function estadisticaInseminacionController($location, $scope, $localStorage, estadisticaInseminacionService, toastr, $sessionStorage) {
        var vm = $scope;
        ...
        function descargarPdf(idDeImagen, titulo) {
            ...
            var docDefinition = {
                content: [
                    ...
                    {
                        text: 'Generado por: ' + $sessionStorage.usuarioInfo.usuario, fontSize: 15
                    },
                    {
                        text: 'Fecha: ' + (fecha.getDate() + '-' + (fecha.getMonth() + 1) + '-' + fecha.getFullYear()), fontSize: 15
                    },
                    {
                        text: 'Campo: ' + $localStorage.usuarioInfo.campoNombre, fontSize: 15
                    },
                    {
                        image: imgSrc,
                        width: 600,
            ...
            pdfMake.createPdf(docDefinition).download(titulo + $localStorage.usuarioInfo.campoNombre + ' - ' + (fecha.getDate() + '-' + (fecha.getMonth() + 1) + '-' + fecha.getFullYear()) + '.pdf');
        };
