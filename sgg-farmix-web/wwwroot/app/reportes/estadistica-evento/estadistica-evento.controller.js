(function () {
    ...
    estadisticaEventoController.$inject = ['$location', '$scope', '$localStorage', 'estadisticaEventoService', 'toastr', '$sessionStorage'];

    function estadisticaEventoController($location, $scope, $localStorage, estadisticaEventoService, toastr, $sessionStorage) {
        var vm = $scope;
